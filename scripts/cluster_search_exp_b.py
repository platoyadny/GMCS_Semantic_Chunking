# EXPERIMENT B: smaller clusters (min=5) + top-8 clusters
"""
cluster_search_exp_b.py — Кластерный поиск по банку функциональности для всех ASIS-чанков.
...
def parse_args():
    ...
    parser.add_argument(
        "--pre_filter_percentile", type=int, default=45,
    ...
    parser.add_argument(
        "--hdbscan_min_samples", type=int, default=5,
    ...
    # ----- Отбор кластеров -----
    parser.add_argument(
        "--top_clusters", type=int, default=8,
